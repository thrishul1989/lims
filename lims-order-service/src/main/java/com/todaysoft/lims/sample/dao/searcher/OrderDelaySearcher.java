...
@Builder
@AllArgsConstructor
public class OrderDelaySearcher implements ISearcher<OrderDelay>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("select s FROM OrderDelay s left join s.orderId.orderExamineeList e  WHERE 1=1 ");
    ...
    @Override
    public Class<OrderDelay> getEntityClass()
    {
        // TODO Auto-generated method stub
        return OrderDelay.class;
    }
