...
public class ResamplingCancelSolveSearcher extends IDataAuthoritySearcher implements ISearcher<ResamplingCancelSolveRecord>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM ResamplingCancelSolveRecord r ");
        hql.append(" WHERE EXISTS (SELECT v.id FROM OrderSampleView  v ,Order s WHERE v.sampleId = r.record.abnormalSampleId and v.orderId = s.id ");
        ...
        hql.append(") ORDER BY r.solveTime DESC");
    ...
    @Override
    public Class<ResamplingCancelSolveRecord> getEntityClass()
    {
        return ResamplingCancelSolveRecord.class;
    }
