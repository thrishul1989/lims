...
public class Configs
{
    ...
    @Value("${aliyun.ons.consumer.orderStatus}")
    private String aliyunONSOrderStatusConsumer;
    
    public String getAliyunONSOrderStatusConsumer()
    {
        return aliyunONSOrderStatusConsumer;
    }
    
    public void setAliyunONSOrderStatusConsumer(String aliyunONSOrderStatusConsumer)
    {
        this.aliyunONSOrderStatusConsumer = aliyunONSOrderStatusConsumer;
    }
