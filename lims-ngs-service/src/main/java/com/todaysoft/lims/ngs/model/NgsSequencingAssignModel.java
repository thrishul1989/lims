...
public class NgsSequencingAssignModel {
	private String id;
	...
	private List<NgsSequecingMachine> sequecingMachineList;

	public List<NgsSequecingMachine> getSequecingMachineList() {
		return sequecingMachineList;
	}

	public void setSequecingMachineList(List<NgsSequecingMachine> sequecingMachineList) {
		this.sequecingMachineList = sequecingMachineList;
	}
