...
import com.todaysoft.lims.ngs.service.MessageConsumerFactory;

@Component
@Lazy(false)
public class NgsConsumer implements MessageListener {
	private static Logger log = LoggerFactory.getLogger(NgsConsumer.class);

	public static final String TAG_NGS_CREATE_MESSAGE = "NGS_CREATE_MESSAGE";
	...
	private void register() {
		...
		properties.put(PropertyKeyConst.ConsumerId, configs.getAliyunONSNgsConsumer());
		...
		if (log.isDebugEnabled()) {
			log.debug("Start aliyun ons consumer success, subscribe topic {}, expression {}, consumer id {}", configs.getAliyunONSTopic(), tags,
					configs.getAliyunONSNgsConsumer());
		}
	}
