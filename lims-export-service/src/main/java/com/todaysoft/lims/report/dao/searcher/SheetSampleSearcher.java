...
public class SheetSampleSearcher implements ISearcher<ReportSheetSample>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append(" FROM ReportSheetSample t WHERE t.reportTaskId=:reportTaskId ");
    ...
    @Override
    public Class<ReportSheetSample> getEntityClass()
    {
        return ReportSheetSample.class;
    }
