...
import com.todaysoft.lims.technical.mybatis.DataTemplateColumnMapper;
import com.todaysoft.lims.technical.mybatis.DataTemplateMapper;
...
public class DataTemplateService implements IDataTemplateService {
	...
	@Override
	public List<DataTemplateColumn> getColumnByGroupName(String groupName, String templateId) {
		DataTemplateColumn col = new DataTemplateColumn();
		col.setGroupName(groupName);
		col.setTemplateId(templateId);
		return columnMapper.selectByGroupName(col);
	}

	@Override
	public List<DataTemplateColumn> getColumn(String templateId) {
