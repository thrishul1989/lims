...
public class SubmitCnvVerifyRequest
{
    ...
    private List<String> mLPAverifySampleRelation;    //MLPA分析样本关系,样本id;关系   如adb2222;父亲
    private List<String> qPCRVerifySampleRelation;     //QPCR分析样本关系,样本id;关系   如adb2222;父亲
