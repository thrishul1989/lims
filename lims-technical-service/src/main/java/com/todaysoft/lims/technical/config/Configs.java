...
public class Configs {
	...
	@Value("${aliyun.ons.consumer.technical}")
	private String aliyunONSTechnicalConsumer;
	...
	public String getAliyunONSTechnicalConsumer() {
		return aliyunONSTechnicalConsumer;
	}

	public void setAliyunONSTechnicalConsumer(String aliyunONSTechnicalConsumer) {
		this.aliyunONSTechnicalConsumer = aliyunONSTechnicalConsumer;
	}
