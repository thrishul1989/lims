...
public class MutationStatisticsModel
{
    ...
    private String leastFour;
    
    private String leastFive;
    ...
    public String getLeastFour()
    {
        return leastFour;
    }
    
    public void setLeastFour(String leastFour)
    {
        this.leastFour = leastFour;
    }
    
    public String getLeastFive()
    {
        return leastFive;
    }
    
    public void setLeastFive(String leastFive)
    {
