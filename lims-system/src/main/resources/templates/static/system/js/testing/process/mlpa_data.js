    ...
    }).on('click', '.check-instance', function()
    {
        ...
        else
        {
            ...
            function(e)
            {
                ...
                var assignableDataTemplate1 = true;
        		var dataTemplateId1;
        		var dataTemplateIdType1 = "";
        		var productName = "";
        		var str = [];
                instances.each(function()
                {
                    keys.push($(this).val());
                    dataTemplateId = $(this).attr('data-type');
                    ...
                    dataTemplateId1 = $(this).attr('data-templateId');
        			...
        			if ("" == dataTemplateIdType1) {
        				dataTemplateIdType1 = dataTemplateId1;
        			} else {
        				if (dataTemplateIdType1 != dataTemplateId1) {
        					assignableDataTemplate = false;
        				}
        			}
                });
                ...
                {
                    parent.layer.alert('检测跟验证不能一起下达，请重新选择',{title:"提示"});
                    return false;
                }
