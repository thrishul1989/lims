...
if (prjManagerUser!=1)
{
	...
	$(testProduct).on('selectionchange', function(e,m){
		...
		if(productsPrice.length >0){
			...
			$.each(productsPrice,function(index,obj){
				...
				$.each(insampemap.notempty(),function(index,ob){
	...
	'<label class="col-sm-2 control-label control-required"><span>*</span>样本类型：</label>'+
					'<div class="col-sm-3">'+
						'<select class="form-control" name="mainSampleType" onchange="showUnit(this)"  id="mainSampleType_n"'+
							' >'+
	...
	//样本类型
		...
		$.each(order.orderSubsidiarySample,function(index,obj){
			...
			$('#seContent').append('<div style="margin-top:17px" class="seGroup"> <img src="'
					+system_images+'/rubish.png" style="float: right;cursor: pointer;" onclick="removeSeSample(this)"/>'+
					'<div class="form-group">'+
					'<label class="col-sm-2 control-label control-required"><span>*</span>样本编号：</label>'+
					'<div class="col-sm-3">'+
					...
					'<label class="col-sm-2 control-label control-required"><span>*</span>样本类型：</label>'+
					'<div class="col-sm-3">'+
						'<select class="form-control" name="seSampleType" id="seSampleType_n"  onchange="showSeUnit(this)" >'+
				...
				'<div class="form-group">'+
					...
					'<div class="col-sm-3">'+
						'<input type="text" class="form-control"'+
							'name="seSampleSize"  value="'+obj.sampleSize+'" />'+
					'</div>'+

					'<label class="col-sm-2 control-label control-required"><span>*</span>采样时间：</label>'+
					'<div class="col-sm-3">'+
						'<input type="text" class="form-control laydate-icon"'+
							'name="seSampleDate"  value="'+ obj.samplingDate+'" '+
							'style="height: 34px"'+
							'onclick="laydate({istime: true, format: \'YYYY-MM-DD\',max: laydate.now()})" />'+
					'</div>'+
				...
				'<div class="form-group">'+
					...
					'<div class="col-sm-3">'+
						'<select class="form-control" name="purpose" ids="'+j+'" id="purpose'+j+'"  '+
							'>'+
...
function addSe(){
	...
	$('#seContent').append('<div style="margin-top:17px" class="seGroup"><img src="'
		...
		'<div class="form-group">'+
			...
			'<select class="form-control" name="purpose" id="purpose'+j+'" ids="'+j+'" >'+
