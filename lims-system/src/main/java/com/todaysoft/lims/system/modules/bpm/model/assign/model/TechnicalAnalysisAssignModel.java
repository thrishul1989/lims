...
public class TechnicalAnalysisAssignModel
{
    ...
    private List<TechnicalAnalysisAssignTask> tasks;
    ...
    public List<TechnicalAnalysisAssignTask> getTasks()
    {
        return tasks;
    }
    
    public void setTasks(List<TechnicalAnalysisAssignTask> tasks)
    {
        this.tasks = tasks;
    }
