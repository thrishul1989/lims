...
public class QpcrDataAnalRecordResolver
{
    private ZipFileUploadModel model;

    private DataTemplate dataTemplate;

    public QpcrDataAnalRecordResolver(ZipFileUploadModel model, DataTemplate dataTemplate)
    {
        this.model = model;
        this.dataTemplate = dataTemplate;
    }
    
    public List<QpcrSubmitTask> resolve()
    {
        ...
        try
        {
            ...
            List<QpcrSubmitTask> records = new ArrayList<QpcrSubmitTask>();
    ...
    public void wrap(String key,QpcrSubmitTask record,String value)
    {
