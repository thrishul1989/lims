...
public class MlpaDataAnalRecordResolver
{
    private ZipFileUploadModel model;

    private DataTemplate dataTemplate;

    public MlpaDataAnalRecordResolver(ZipFileUploadModel model, DataTemplate dataTemplate)
    {
        this.model = model;
        this.dataTemplate = dataTemplate;
    }
    
    public List<MlpaDataSubmitTaskSuccessArgs> resolve()
    {
        ...
        try
        {
            ...
            List<MlpaDataSubmitTaskSuccessArgs> records = new ArrayList<MlpaDataSubmitTaskSuccessArgs>();
            ...
            MlpaDataSubmitTaskSuccessArgs record;
            //取数据行
            Row row;
            for (int i = dataIndex-1; i <= sheet.getLastRowNum(); i++)
            {
                ...
                record = new MlpaDataSubmitTaskSuccessArgs();
    ...
    public void wrap(String key,MlpaDataSubmitTaskSuccessArgs record,String value)
    {
