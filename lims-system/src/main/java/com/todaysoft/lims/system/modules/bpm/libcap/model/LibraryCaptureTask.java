...
public class LibraryCaptureTask
{
    ...
    public String getProbeLessFive()
    {
        return probeLessFive;
    }
    
    public void setProbeLessFive(String probeLessFive)
    {
        this.probeLessFive = probeLessFive;
    }
