...
@Controller
@RequestMapping(value = "/bpm/report/completedReport")
public class ReportCompletedController extends BaseController
{
    @Autowired
    private IReportCompletedService service;
    ...
    public String paging(CompletedReportSearcher searcher, @RequestParam(value = "pageNo", defaultValue = "1", required = false) int pageNo, @RequestParam(value = "pageSize", defaultValue = "10", required = false) int pageSize, ModelMap model, HttpSession session)
    {
        ...
        return "report/reportReview/reportCompleted_list";
    }
    ...
    public String view(String id, ModelMap model)
    {
        ...
        return "report/reportReview/reportCompleted_details";
    }
        ...
        throws TransformerException, IOException, ParserConfigurationException
    {
        ...
        if(file.exists())
        {
         // 转字符串
            ...
            String s = replaceHtmlTag(infoStream.toString(DEFAULT_ENCODING), "img", "src", "src=\"/bpm/report/completedReport/downloadPic.do?fileName=", "\"");
            return s;
        }
        return null;
