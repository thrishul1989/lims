...
public class FluoDataAnalRecordResolver
{
    private ZipFileUploadModel model;

    private DataTemplate dataTemplate;

    public FluoDataAnalRecordResolver(ZipFileUploadModel model, DataTemplate dataTemplate)
    {
        this.model = model;
        this.dataTemplate = dataTemplate;
    }
    
    public List<FluoDataSubmitTaskSuccessArgs> resolve()
    {
        ...
        try
        {
            ...
            List<FluoDataSubmitTaskSuccessArgs> records = new ArrayList<FluoDataSubmitTaskSuccessArgs>();
            ...
            FluoDataSubmitTaskSuccessArgs record;
            //取数据行
            Row row;
            for (int i = dataIndex-1; i <= sheet.getLastRowNum(); i++)
            {
                ...
                record = new FluoDataSubmitTaskSuccessArgs();
    ...
    public void wrap(String key,FluoDataSubmitTaskSuccessArgs record,String value)
    {
