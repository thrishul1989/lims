...
public class ReportEmailModel
{
    ...
    private String reportInvoiceOrderIds;//冗余请求字段
    ...
    public String getReportInvoiceOrderIds()
    {
        return reportInvoiceOrderIds;
    }
    
    public void setReportInvoiceOrderIds(String reportInvoiceOrderIds)
    {
        this.reportInvoiceOrderIds = reportInvoiceOrderIds;
    }
