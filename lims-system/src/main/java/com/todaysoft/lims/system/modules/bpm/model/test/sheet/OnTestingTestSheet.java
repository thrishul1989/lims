...
import com.todaysoft.lims.system.modules.bpm.model.test.sheet.task.OnTestingTestSheetTask;

public class OnTestingTestSheet
{
    ...
    private List<OnTestingTestSheetTask> testSheetTaskList = Lists.newArrayList();
    ...
    public List<OnTestingTestSheetTask> getTestSheetTaskList()
    {
        return testSheetTaskList;
    }
    
    public void setTestSheetTaskList(List<OnTestingTestSheetTask> testSheetTaskList)
    {
