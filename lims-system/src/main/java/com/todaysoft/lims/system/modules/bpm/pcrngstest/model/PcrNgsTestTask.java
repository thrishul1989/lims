...
public class PcrNgsTestTask
{
    ...
    private String libraryIndexLocation;
    ...
    public String getLibraryIndexLocation()
    {
        return libraryIndexLocation;
    }
    
    public void setLibraryIndexLocation(String libraryIndexLocation)
    {
        this.libraryIndexLocation = libraryIndexLocation;
    }
