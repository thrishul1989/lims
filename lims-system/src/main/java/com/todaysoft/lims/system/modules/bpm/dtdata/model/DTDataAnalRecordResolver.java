...
public class DTDataAnalRecordResolver
{
    private ZipFileUploadModel model;

    private DataTemplate dataTemplate;

    public DTDataAnalRecordResolver(ZipFileUploadModel model, DataTemplate dataTemplate)
    {
        this.model = model;
        this.dataTemplate = dataTemplate;
    }
    
    public List<DTDataSubmitTaskSuccessArgs> resolve()
    {
        ...
        try
        {
            ...
            List<DTDataSubmitTaskSuccessArgs> records = new ArrayList<DTDataSubmitTaskSuccessArgs>();
            ...
            DTDataSubmitTaskSuccessArgs record;
            //取数据行
            Row row;
            for (int i = dataIndex-1; i <= sheet.getLastRowNum(); i++)
            {
                ...
                record = new DTDataSubmitTaskSuccessArgs();
    ...
    public void wrap(String key,DTDataSubmitTaskSuccessArgs record,String value)
    {
