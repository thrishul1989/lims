...
public class DataPcrSangerDataAnalRecordResolver
{
    private ZipFileUploadModel model;

    private DataTemplate dataTemplate;

    public DataPcrSangerDataAnalRecordResolver(ZipFileUploadModel model, DataTemplate dataTemplate)
    {
        this.model = model;
        this.dataTemplate = dataTemplate;
    }
    
    public List<DataPcrSangerSubmitTaskArgs> resolve()
    {
        ...
        try
        {
            ...
            List<DataPcrSangerSubmitTaskArgs> records = new ArrayList<DataPcrSangerSubmitTaskArgs>();
            ...
            DataPcrSangerSubmitTaskArgs record;
            //取数据行
            Row row;
            for (int i = dataIndex-1; i <= sheet.getLastRowNum(); i++)
            {
                ...
                record = new DataPcrSangerSubmitTaskArgs();
    ...
    public void wrap(String key,DataPcrSangerSubmitTaskArgs record,String value)
    {
