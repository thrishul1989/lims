...
public class DataPcrDataAnalRecordResolver
{
    private ZipFileUploadModel model;

    private DataTemplate dataTemplate;

    public DataPcrDataAnalRecordResolver(ZipFileUploadModel model, DataTemplate dataTemplate)
    {
        this.model = model;
        this.dataTemplate = dataTemplate;
    }
    
    public List<DataPcrSubmitTaskArgs> resolve()
    {
        ...
        try
        {
            ...
            List<DataPcrSubmitTaskArgs> records = new ArrayList<DataPcrSubmitTaskArgs>();
            ...
            for (int i = dataIndex-1; i <= sheet.getLastRowNum(); i++)
            {
                ...
                record = new DataPcrSubmitTaskArgs();
    ...
    public void wrap(String key,DataPcrSubmitTaskArgs record,String value)
    {
