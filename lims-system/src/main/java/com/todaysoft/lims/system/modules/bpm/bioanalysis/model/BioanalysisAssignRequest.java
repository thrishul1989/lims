...
public class BioanalysisAssignRequest
{
    private String id;
    ...
    private List<BioanalysisAssignTaskArgs> tasks;
    ...
    public List<BioanalysisAssignTaskArgs> getTasks()
    {
        return tasks;
    }

    public void setTasks(List<BioanalysisAssignTaskArgs> tasks)
    {
        this.tasks = tasks;
    }
}
