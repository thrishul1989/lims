...
public class TechnicalAnalyTask
{
    ...
    public int hashCode()
    {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((sequencingCode == null) ? 0 : sequencingCode.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        if (getClass() != obj.getClass())
            return false;
        TechnicalAnalyTask other = (TechnicalAnalyTask)obj;
        if (sequencingCode == null)
        {
            if (other.sequencingCode != null)
                return false;
        }
        else if (!sequencingCode.equals(other.sequencingCode))
            return false;
        return true;
    }
