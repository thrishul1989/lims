...
public class AdvanceInvoiceImportModelResolver
{
    private MultipartFile data;
    
    public AdvanceInvoiceImportModelResolver(MultipartFile data)
    {
        this.data = data;
    }
    
    public List<AdvanceInvoiceImportModel> resolve()
    {
        try
        {
            ...
            List<AdvanceInvoiceImportModel> records = Lists.newArrayList();
    ...
    private Map<Integer, Field> mapping()
    {
        ...
        Field[] fields = AdvanceInvoiceImportModel.class.getDeclaredFields();
    ...
    private AdvanceInvoiceImportModel getRecord(Row row, Map<Integer, Field> fields)
    {
        AdvanceInvoiceImportModel record = new AdvanceInvoiceImportModel();
