...
public class MultiPcrAssignableTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM TestingTask t WHERE t.semantic = 'MULTI-PCR' AND t.status = :assignableStatus");
