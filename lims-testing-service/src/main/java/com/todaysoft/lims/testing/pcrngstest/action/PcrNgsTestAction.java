package com.todaysoft.lims.testing.pcrngstest.action;
...
@RestController
@RequestMapping("/bpm/testing/pcrNgsTest")
public class PcrNgsTestAction
{
    ...
    public List<PcrNgsTestTask> assignable(@RequestBody PcrNgsTestAssignableTaskSearcher searcher)
    {
        return service.getAssignableList(searcher);
    }
    
    @RequestMapping(value = "/tasks/assigning", method = RequestMethod.POST)
    public PcrNgsTestAssignModel assigning(@RequestBody PcrNgsTestAssignArgs args)
    {
        return service.getAssignableModel(args);
    }
    
    @RequestMapping(value = "/tasks/assign", method = RequestMethod.POST)
    public void assign(@RequestBody PcrNgsTestAssignRequest request, @RequestHeader(RequestHeaders.MEMBER_TOKEN) String token)
    {
        service.assign(request, token);
    }
    
    @RequestMapping(value = "/sheets/{id}", method = RequestMethod.GET)
    public PcrNgsTestSheetModel sheet(@PathVariable String id)
    {
        return service.getTestingSheet(id);
    }
    
    @RequestMapping(value = "/sheets/submit", method = RequestMethod.POST)
    public void submit(@RequestBody PcrNgsTestSubmitRequest request, @RequestHeader(RequestHeaders.MEMBER_TOKEN) String token)
    {
