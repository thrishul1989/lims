...
public class FirstPcrTask
{
    ...
    public String getAnalyRecordId()
    {
        return analyRecordId;
    }
    
    public void setAnalyRecordId(String analyRecordId)
    {
        this.analyRecordId = analyRecordId;
    }
