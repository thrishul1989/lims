package com.todaysoft.lims.testing.pcrngstest.dao;
...
public class PcrNgsTestAssignableTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM TestingTask t WHERE t.semantic = 'PCR-NGS' AND t.status = :assignableStatus ");
