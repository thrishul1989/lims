package com.todaysoft.lims.testing.primerdesign.dao;
...
public class PrimerDesignAssignableTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM TestingTask t WHERE t.semantic = 'PRIMER-DESIGN' AND t.status = 1 ");
