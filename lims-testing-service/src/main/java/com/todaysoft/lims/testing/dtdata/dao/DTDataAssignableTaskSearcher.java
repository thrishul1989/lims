package com.todaysoft.lims.testing.dtdata.dao;
...
public class DTDataAssignableTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM TestingTask t WHERE t.semantic = 'DT-DATA-ANALYSIS' AND t.status = :assignableStatus");
