package com.todaysoft.lims.testing.cdnaqc.dao;
...
public class CDNAQcTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM TestingTask t WHERE t.semantic = 'CDNA-QC'");
