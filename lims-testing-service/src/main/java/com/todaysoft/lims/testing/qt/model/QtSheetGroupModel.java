...
public class QtSheetGroupModel
{
    private String id;
    ...
    private List<QtSheetSampleModel> samples;
    ...
    public List<QtSheetSampleModel> getSamples()
    {
        return samples;
    }
    
    public void setSamples(List<QtSheetSampleModel> samples)
    {
