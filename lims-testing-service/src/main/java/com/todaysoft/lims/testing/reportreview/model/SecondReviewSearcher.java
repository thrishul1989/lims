...
public class SecondReviewSearcher implements ISearcher<TestingReport>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("SELECT tr FROM TestingReport tr, OrderProduct op WHERE tr.status = 2 AND tr.delFlag = false AND tr.secondReviewStatus = '0' AND op.order.id = tr.order.id AND op.product.id = tr.product.id");
