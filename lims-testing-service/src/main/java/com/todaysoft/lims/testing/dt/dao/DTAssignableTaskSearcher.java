package com.todaysoft.lims.testing.dt.dao;
...
public class DTAssignableTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM TestingTask t WHERE t.semantic = 'DT' AND t.status = :assignableStatus");
