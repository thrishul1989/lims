package com.todaysoft.lims.testing.libcap.dao;
...
public class LibraryCaptureAssignableTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM TestingTask t WHERE t.semantic = 'LIBRARY-CAP' AND t.status = :assignableStatus");
