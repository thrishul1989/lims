...
public class TestingSchedule extends UuidKeyEntity implements Serializable
{
    ...
    {
        return "TestingSchedule [orderId=" + orderId + ", productId=" + productId + ", methodId=" + methodId + ", sampleId=" + sampleId + ", startTime="
            + startTime + ", activeTask=" + activeTask + ", endTime=" + endTime + ", endType=" + endType + ", scheduleNodes=" + scheduleNodes
            + ", scheduleOutPuts=" + scheduleOutPuts + ", verifyKey=" + verifyKey + ", verifyTarget=" + verifyTarget + ", proccessState=" + proccessState + "]";
    }
