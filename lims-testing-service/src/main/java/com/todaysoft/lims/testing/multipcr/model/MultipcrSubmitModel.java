...
public class MultipcrSubmitModel
{
    private String id;
    ...
    private List<MultipcrAssignModel> tasks;
    ...
    public List<MultipcrAssignModel> getTasks()
    {
        return tasks;
    }
    
    public void setTasks(List<MultipcrAssignModel> tasks)
    {
        this.tasks = tasks;
    }
