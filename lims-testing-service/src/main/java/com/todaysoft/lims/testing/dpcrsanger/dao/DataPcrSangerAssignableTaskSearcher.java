package com.todaysoft.lims.testing.dpcrsanger.dao;
...
public class DataPcrSangerAssignableTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM TestingTask t WHERE t.semantic = 'SANGER-DATA-ANALYSIS' AND t.status = :assignableStatus");
