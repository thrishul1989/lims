...
public class LibraryCaptureSubmitSolveTaskContext
{
    ...
    private Map<String, LibraryCaptureSubmitScheduleContext> relatedSchedules;
    ...
    public Map<String, LibraryCaptureSubmitScheduleContext> getRelatedSchedules()
    {
        return relatedSchedules;
    }
    
    public void setRelatedSchedules(Map<String, LibraryCaptureSubmitScheduleContext> relatedSchedules)
    {
