package com.todaysoft.lims.testing.ontesting.dao;
...
public class SequencingAssignableTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        names.add("semantic");
        values.add(TaskSemantic.NGS_SEQ);
