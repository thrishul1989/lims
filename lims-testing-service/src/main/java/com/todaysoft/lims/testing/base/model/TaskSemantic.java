...
public class TaskSemantic
{
    ...
    public static final String BIOLOGY_DIVISION = "BIOLOGY-DIVISION";//数据拆分
    ...
    public static final String BIOLOGY_ANNOTATION = "BIOLOGY-ANNOTATION";//生信注释任务关键字
    
    public static final String TECHNICAL_ANALYSIS_TASK = "TECHNICAL-ANALYSIS";//新技术分析任务关键字
    ...
    public static final String RE_EXPERIMENT = "RE_EXPERIMENT";//重新实验实验
    
    public static final String CATCH_SAMPLE_TYPE_ID = "200173e8bd454bb7b860e1113c01ab8c";
    
    public static final String LIB_SAMPLE_TYPE_ID = "2000d8debb1f4c3e825dd5a3f4de4966";
    
    public static final String MULTIPCR_SAMPLE_TYPE_ID = "40a69b8c48054935a10a64ec5fc955dd";
    
    public static final String LONGPCR_SAMPLE_TYPE_ID = "a1c748bc1dc74715a340872d460960fb";
    
    public static final String PCRNGS_SAMPLE_TYPE_ID = "ced00cd8f18c11e68ee90242ac110004";
