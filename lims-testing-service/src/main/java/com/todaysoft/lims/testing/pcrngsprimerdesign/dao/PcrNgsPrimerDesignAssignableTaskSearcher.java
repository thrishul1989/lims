package com.todaysoft.lims.testing.pcrngsprimerdesign.dao;
...
public class PcrNgsPrimerDesignAssignableTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM TestingTask t WHERE t.semantic = 'PCR-NGS-PRIMER-DESIGN' AND t.status = :assignableStatus ");
