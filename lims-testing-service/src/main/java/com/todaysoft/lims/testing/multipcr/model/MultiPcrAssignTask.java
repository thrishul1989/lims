...
public class MultiPcrAssignTask
{
    ...
    public static int getStatusAssignable()
    {
        return STATUS_ASSIGNABLE;
    }
    
    public static int getStatusAssigning()
    {
        return STATUS_ASSIGNING;
    }
    
    public static int getStatusEnd()
    {
        return STATUS_END;
    }
    
    public static int getEndFailure()
    {
        return END_FAILURE;
    }
    
    public static int getEndSuccess()
    {
        return END_SUCCESS;
    }
