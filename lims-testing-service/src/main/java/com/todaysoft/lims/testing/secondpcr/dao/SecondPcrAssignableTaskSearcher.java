package com.todaysoft.lims.testing.secondpcr.dao;
...
public class SecondPcrAssignableTaskSearcher implements ISearcher<TestingTask>
{
    ...
    public NamedQueryer toQuery()
    {
        ...
        hql.append("FROM TestingTask t WHERE t.semantic = 'PCR-TWO' AND t.status = :assignableStatus");
        ...
        hql.append(" ORDER BY t.startTime");
